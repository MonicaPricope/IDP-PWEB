...
CREATE TABLE test.reservation ( id INT NULL , user_id INT NOT NULL , location_id INT NOT NULL , start_time TIME NOT NULL , end_time TIME NOT NULL , PRIMARY KEY (id)) ENGINE = InnoDB;
