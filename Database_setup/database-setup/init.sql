...
CREATE TABLE test.shelter2 ( id INT NOT NULL AUTO_INCREMENT , title VARCHAR(20) NOT NULL , location VARCHAR(20) NOT NULL , admin_name VARCHAR(25) NOT NULL , admin_phone VARCHAR(15) NOT NULL , ocupants INT NOT NULL , capacity INT NOT NULL , user_id INT NOT NULL , PRIMARY KEY (id)) ENGINE = InnoDB;
